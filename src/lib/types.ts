...
export type Invoice = {
  ...
  /** Official invoice total. When set, cash uses this instead of the item sum. */
...
/** Synthetic invoice line that fills the gap between itemized purchases and the official total. */
export const INVOICE_ADJUSTMENT_TAG = "ajuste-fatura"
export const INVOICE_ADJUSTMENT_DESCRIPTION = "Ajuste de fatura"

export type ObligationKind = "fixa" | "variavel" | "emprestimo"
